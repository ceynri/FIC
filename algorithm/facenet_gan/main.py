...
if __name__ == '__main__':
    ...
    epoch = 0
    total_it = 0
    writer = SummaryWriter(TENSORBOARD_PATH, comment='_facenet_gan')
        ...
        torch.save(
            {
                ...
                'D_loss': net.loss_D,
                'total_it': total_it
            }, f'{SAVE_DIR}/facenet_gan_checkpoints')
        if epoch % 10 == 0:
            torch.save(net.state_dict(), f"{SAVE_DIR}/facenet_gan_{epoch}.pth")
